...
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.function.GameTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.function.TourneyTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.function.RoundTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.table.ShuffledDeckProviderTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.table.DealerTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.table.HandTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.player.PlayerTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.strategy.MinCardTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.strategy.MaxCardTest
java -cp $CLASSPATH org.junit.runner.JUnitCore org.peidevs.waro.strategy.NextCardTest
